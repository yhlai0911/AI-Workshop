...
原始連結：https://docs.llamaindex.ai/en/stable/module_guides/storing/customization/

# Customizing Storage#

[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/customization/#customizing-storage)
...
[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/customization/#low-level-api)
...
See [Document Stores](https://docs.llamaindex.ai/en/stable/module_guides/storing/docstores/), [Vector Stores](https://docs.llamaindex.ai/en/stable/module_guides/storing/vector_stores/), [Index Stores](https://docs.llamaindex.ai/en/stable/module_guides/storing/index_stores/) guides for more details.

### Vector Store Integrations and Storage#

[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/customization/#vector-store-integrations-and-storage)
